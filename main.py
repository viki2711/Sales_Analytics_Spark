...
print(f'2. The most expensive item that user {user_id} purchased was: '
      f'item_id: {item_id}, cost: {item_base_cost}$, '
      f'item info - quality: {quality}, price: {price}$, name: {name}')
...
for user in selected_users:
    ...
    print(f'3. {user_name}, account_id: {account}, spent: {sum_paid}$')
